...
export class SamCollapsibleComponent implements OnChanges {
  /**
   * The label input is the name of the collapsible section header that will be
   * visible to the user
   */
  @Input() public label: string;

  /**
   * The startOpened input intializes the component in the open state if set to
   * true. Otherwise, the component defaults to closed.
   */
