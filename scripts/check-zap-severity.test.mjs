 ...
 * real CLI surface (exit codes, riskcode gating, .zap/rules.tsv exceptions)
...
// rule-id  IGNORE  scope  issue  owner  expiry  rationale
function ruleRow(pluginId, scope = "*") {
  return `${pluginId}\tIGNORE\t${scope}\thttps://github.com/GSA/sam-ui-elements/issues/1\towner\t2999-01-01\trationale`;
}
