    ...
    it('returns a string', function() {
      ...
      var expected = 	'<section id="iae-footer"><footer><div class="usa-grid-full usa-footer-return-to-top"><a href="#">Return to top</a>' +
						'</div><div class="iae-footer"><div class="iae-footer-body usa-grid-full">' +
			             ...
			             '<a class="image-wrap" href="http://www.gsa.gov" target="_blank"><img alt="GSA logo" src="http://test.sam.gov/assets/img/logo-gsa.png"></a></div>' +
						...
						'<li class="m_B"><a href="http://test.sam.gov/for-developers/" title="For Developers">For Developers</a></li></ul></li></ul></div></div></footer></section>';
