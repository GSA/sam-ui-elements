...
@Component({
  template: `
    ...
    <a id="hidden" target="hidden" hideIcon="true"> Hidden </a>
  `,
  standalone: false,
})
class TestComponent {}
...
describe("Sam External Link Directive", () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      declarations: [TestComponent, SamExternalLinkDirective],
    });
  ...
  it("should add external link icon when none is present", () => {
    const cmp = fixture.debugElement.query(By.css("#named"));
  ...
  it("should not add icon if hideIcon is true", () => {
    const cmp = fixture.debugElement.query(By.css("#hidden"));
