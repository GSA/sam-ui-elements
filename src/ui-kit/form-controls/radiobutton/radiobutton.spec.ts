...
describe("The Sam Radio Buttons component", () => {
  ...
  describe("rendered tests", () => {
    ...
    it("should display 3 radiobuttons if 3 options are specified by the config", function () {
      ...
      expect(fixture.nativeElement.getElementsByTagName("input").length).toBe(
        options.length
      );
    });

    it("should allow an initial value to be set by the model input", waitForAsync(() => {
      component.model = "ma";
      fixture.detectChanges();

      const checkedElement = fixture.debugElement.query(
        By.css(":checked + label")
      );
    ...
    it("should deselect one radio button when another is clicked", function () {
      ...
      const label1 = fixture.debugElement.query(By.css(":checked + label"))
        .nativeElement.innerHTML;

      component.model = "dc";
      fixture.detectChanges();

      const label2 = fixture.debugElement.query(By.css(":checked + label"))
        .nativeElement.innerHTML;
