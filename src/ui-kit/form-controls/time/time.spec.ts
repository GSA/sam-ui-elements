...
describe('The Sam Time component', () => {
  ...
  describe('rendered test', ()=>{
    ...
    it('should render resets', ()=>{
      ...
      fixture.detectChanges();
      expect(component.hour_v.nativeElement.value).toBe("");
      expect(component.minute_v.nativeElement.value).toBe("");
    });

    it('should process keypress', ()=>{
      let hourEl = fixture.debugElement.queryAll(By.css("input"))[0];
      let minuteEl = fixture.debugElement.queryAll(By.css("input"))[1];
      ...
      let time = component.getTime().format(component.OUTPUT_FORMAT);
