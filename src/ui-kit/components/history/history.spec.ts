...
describe("The SAM History Component", () => {
  ...
  it("check markup", () => {
    ...
    // Date
    expect(
      fixture.debugElement.query(By.css("ul li:nth-child(1) strong"))
        .nativeElement.innerHTML
    ).toBe("Feb 04, 2016 8:20am");
    // Title
    expect(
      fixture.debugElement.query(By.css("ul li:nth-child(1) a")).nativeElement
        .innerHTML
    ).toBe("Original Combined Synopsis/Solicitation");
    // Description
    expect(
      fixture.debugElement.query(By.css("ul li:nth-child(1) p")).nativeElement
        .innerHTML
    ).toBe("Lorem Ipsum");
    // URL
    expect(
      fixture.debugElement
        .query(By.css("ul li:nth-child(1) a"))
  ...
  it("check current class", () => {
    ...
    expect(
      fixture.debugElement
        .query(By.css("ul li:nth-child(2)"))
