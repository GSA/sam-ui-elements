...
let historyCurrentId = "1a610c814d73fc23a6b71decc9b4c548";
let historyData = [
  {
    authoritative: "0",
...
describe("The SAM History Component", ()=> {
  ...
  it('check markup', () => {
    ...
    // Date
    expect(fixture.debugElement.query(By.css('ul li:nth-child(1) strong')).nativeElement.innerHTML).toBe("Feb 04, 2016 8:20am");
    // Title
