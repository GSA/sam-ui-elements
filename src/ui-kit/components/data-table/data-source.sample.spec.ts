...
export class ExampleDataSource extends DataSource<any> {
  ...
  sortData(data: CFDAData[]): CFDAData[] {
    ...
    return data.sort((a, b) => {
      ...
      if (this._sort.active) {
        const sortable: SamSortable = this._sort.sortables.get(
          this._sort.active
        );
        switch (sortable.id) {
          case "agency":
            ...
            break;
          case "cfdaNumber":
            [propertyA, propertyB] = [a.cfdaNumber, b.cfdaNumber];
            break;
          case "title":
          ...
          case "lastUpdatedDate":
            [propertyA, propertyB] = [a.lastUpdatedDate, b.lastUpdatedDate];
            break;
          case "obligationsUpdated":
            [propertyA, propertyB] = [
              a.obligationsUpdated,
              b.obligationsUpdated,
            ];
            break;
          case "ombReviewDate":
            [propertyA, propertyB] = [a.ombReviewDate, b.ombReviewDate];
            break;
          case "lastPublishedDate":
            [propertyA, propertyB] = [a.lastPublishedDate, b.lastPublishedDate];
            break;
          case "autoPublished":
            [propertyA, propertyB] = [a.autoPublished, b.autoPublished];
            break;
          case "cost":
