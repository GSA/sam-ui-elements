...
describe('The Sam Sort component', () => {
  ...
  it('should show 3 pages before and after the current page, the first page, \
    ...
    const sortItems = fixture.debugElement
      .queryAll(By.css('.usa-sort li'));
    const expectedLen = 13;
    expect(sortItems.length).toBe(expectedLen);

    const ellipsis = fixture.debugElement
      .queryAll(By.css('.usa-sort li span'));
  ...
  it('should hide the first and last ellipsis if the current page is 10 or \
    ...
    const sortItems =
      fixture.debugElement.queryAll(By.css('.usa-sort li'));
    const expected = 12;
    expect(sortItems.length).toBe(expected);
