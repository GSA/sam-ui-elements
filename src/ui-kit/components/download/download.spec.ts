...
describe("SamDownloadComponent", () => {
  ...
  describe("rendered tests", () => {
    ...
    it("download all url set", () => {
      ...
      expect(
        fixture.debugElement
          .query(By.css(".download-container-header .download-button a"))
    ...
    it("check fields", () => {
      fixture.detectChanges();
      expect(
        fixture.debugElement.query(By.css(".card-header h3")).nativeElement
          .innerHTML
      ).toContain("Industry Day IV Change of Location");

      expect(
        fixture.debugElement
          .query(By.css(".download-container .download-button a"))
          .nativeElement.getAttribute("href")
      ...
      expect(
        fixture.debugElement
          .query(
            By.css(
              ".download-container .usa-zebra-list \
