      ...
      var SITE_ROOT = (config.site_root) ? config.site_root : 'https://transition.sam.gov';
    	...
    	var html =  	`<section id="iae-footer"><footer><div class="usa-grid-full usa-footer-return-to-top"><a href="#">Return to top</a>` +
						`</div><div class="iae-footer"><div class="iae-footer-body usa-grid-full">` +
			             ...
			             `<a class="image-wrap" href="http://www.gsa.gov" target="_blank"><img alt="GSA logo" src="${SITE_ROOT}/assets/img/logo-gsa.png"></a></div>` +
						...
						`<li class="m_B"><a href="${SITE_ROOT}/for-developers/" title="For Developers">For Developers</a></li></ul></li></ul></div></div></footer></section>`;
