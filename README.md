...
## Running the app
Note: This repository is meant to be a submodule to other project. Running the app here is not the intended way to use this repo. You can, however, run unit tests.
